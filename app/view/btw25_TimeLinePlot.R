...
ui <- function(id,PlotGraphType="plotly") {
  ...
  makeCardwithgear(title = "BTW25 Auszählung", 
                   headercontent =     div(class = "d-flex justify-content-start",
                                           selectizeInput(inputId = ns("spaltenueberschrift"), label = "spaltenueberschrift:",choices = "nothing selected", 
                                                          #width = "100%",
                                           ...
                                           ,selectizeInput(inputId = ns("Wahlkreis"), label = "Interface:",choices = "nothing selected", 
                                                          #width = "100%",
                                                          multiple = FALSE#, width = "100%"
                                                          ,options = list(
                                                            #create = FALSE,
                                           ...
                                           ,selectizeInput(inputId = ns("Partei"), label = "resulttype:",
...
server <- function(id,btw25daten) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    BTWcolnames<-btw25daten$BTWcolnames
    print(BTWcolnames)
    print("jo")
